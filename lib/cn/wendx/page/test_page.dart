  ...
  Widget build(BuildContext context) {
    var desktopNavigation = DesktopNavigation([
      ...
      NaviRailDestData.create("key4", Icons.settings, "设置",
        ...
        themeProvider
            .refreshTheme(ThemeData(primarySwatch: supportColors[colorIndex]));
        winButtonShow = !winButtonShow;
        windowManager.setTitleBarStyle(TitleBarStyle.hidden,windowButtonVisibility:winButtonShow);
      }),
    ], (int index, NaviRailDestData selectedData,
        BuildContext buildContextNav) {
      SmartDialog.showToast("$index is ${selectedData.label}");
      FuncAreaProvider funcAreaProvider =
          Provider.of<FuncAreaProvider>(buildContextNav, listen: false);
